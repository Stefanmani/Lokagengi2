...
//myntutab
$("#reihaus").click(function() {
  if ( $("#reibody").hasClass("falid") == true) {
    $("#reibody").removeClass("falid");
  } else {
    $("#reibody").addClass("falid");
  } 
});
//myntubreytur
$("#oor").click(function() {
...
//gengitab
$("#gengihaus").click(function(){
   if ( $("#gengid").hasClass("falid") == true) {
    $("#gengid").removeClass("falid");
  } else {
    $("#gengid").addClass("falid");
  } 
});
/*
...
var urvinsla = function(gildi) {
  ...
  $("#g").html(Math.round(magn).toLocaleString())
   if ($(window).width() <= 500) {
  $('html, body').animate ({
    scrollTop: $("#n0"+myntid).offset().top}, 'slow');}
};
